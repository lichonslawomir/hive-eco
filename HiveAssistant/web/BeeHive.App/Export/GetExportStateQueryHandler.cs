...
public class GetExportStateQueryHandler : BaseDataExportService, IQueryHandler<GetExportStateQuery, DateTime?>
{
    ...
    public async Task<DateTime?> HandleQuery(GetExportStateQuery query, CancellationToken cancellationToken)
    {
